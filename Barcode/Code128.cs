...
namespace Emdoor.Barcode
{
        ...
        public class Code128
        {
            ...
            {
               return  this.GetCodeImage(p_Text, null, p_Code);
            }

            public Bitmap GetCodeImage(string p_Text, string p_Title, Encode p_Code)
            {
                string _ViewText = p_Title==null?p_Text:string.Format("{0}:{1}",p_Title, p_Text);
                string _Text = "";
